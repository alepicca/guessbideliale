...
@NamedQueries({
    ...
    @NamedQuery(name="bid.findHistorical", query = "SELECT DISTINCT a FROM bid b JOIN auction a on b.auctionid = a.auctionid WHERE b.bidder = :bidder and a.expdate< :expdate"), 
