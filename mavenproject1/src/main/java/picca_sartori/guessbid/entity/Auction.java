...
public class Auction implements Serializable {
  ...
  //  @ManyToOne
   // @JoinColumn(name="creator", referencedColumnName="username")
    ...
    private Users currentwinner;
    private Users definitivewinner;
    ...
    public void setCurrentwinner(Users currentwinner) {
        this.currentwinner = currentwinner;
    }
     public Users getCurrentwinner() {
        return currentwinner;
    }

    public void setDefinitivewinner(Users definitivewinner) {
        this.definitivewinner = definitivewinner;
    }
    
    public Users getDefinitivewinner() {
